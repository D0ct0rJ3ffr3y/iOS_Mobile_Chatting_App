    ...
    final class RegisterViewController: UIViewController {
        ...
        private let imageView: UIImageView = {
            ...
            imageView.image = UIImage(systemName: "person") //*** change default profile picture
        ...
        private let registerButton: UIButton = {
            let button = UIButton()
            button.setTitle("Sign Up", for: .normal) //*** change to an arrow image
        ...
        override func viewDidLoad() {
            ...
            imageView.isUserInteractionEnabled = true //*** need to open folder for profile picture
        ...
        func alertUserLogInError(message: String = "Please enter all information"){ //*** add more error messages e.g. not valid email, etc...
